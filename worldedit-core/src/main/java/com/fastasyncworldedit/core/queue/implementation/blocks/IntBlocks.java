...
public abstract class IntBlocks implements IBlocks {

    private static final Logger LOGGER = LogManagerCompat.getLogger();

    protected static final Section FULL = new Section() {
        @Override
        public int[] get(IntBlocks blocks, int layer, int[] arr) {
            return arr;
        }

        // Ignore aggressive switch here.
        @Override
        public int[] get(IntBlocks blocks, int layer, int[] arr, boolean aggressive) {
            return arr;
        }
    };
    ...
    public abstract static class Section {
        ...
        static int[] update(IntBlocks blocks, int layer, boolean aggressive) {
        ...
        abstract int[] get(IntBlocks blocks, int layer, int[] data);

        abstract int[] get(IntBlocks blocks, int layer, int[] data, boolean aggressive);

        public final int get(IntBlocks blocks, int layer, int index, int[] data) {
            int normalized = layer - blocks.minSectionPosition;
            int[] section = get(blocks, normalized, data);
            return section[index];
        }

        public final void set(IntBlocks blocks, int layer, int index, int value, int[] data) {
